...
int MPI_Finalize(void)
{
  ...
  if (myid == 0){
    ...
    printf(" \n");
    printf(" $:  *** Begin Timing Report ***\n\
 $:\n\
 $:  Max Fin-Init timer val = %22.6fs at rank %7d\n\
 $:  Min Fin-Init timer val = %22.6fs at rank %7d\n\
 $:  Avg Fin-Init timer val = %22.6fs\n\
 $:\n\
 $:  Max Fin - Min Init val = %22.6fs\n\
 $:  Min Fin - Max Init val = %22.6fs\n\
 $:\n\
 $:     Rank           Elapsed Time      Processor Name\n",
    telp_max, i_telp_max, 
    telp_min, i_telp_min, 
    telp_avg,
    tend_max - tbeg_min, 
  ...
  if (myid == 0){
    ...
    printf(" $:\n");
    printf(" $:  Total global elapsed time = %22.6fs\n", ftimer2-tbeg_avg);
    printf(" $:\n");
...
//  $:\n\
//  $:\n\
//  $:  Max MPI_Init timer val = %22.6f at rank %7d\n\
//  $:  Min MPI_Init timer val = %22.6f at rank %7d\n\
//  $:  Avg MPI_Init timer val = %22.6f\n\
//  $:\n\
//  $:  Max MPI_Fin  timer val = %22.6f at rank %7d\n\
//  $:  Min MPI_Fin  timer val = %22.6f at rank %7d\n\
//  $:  Avg MPI_Fin  timer val = %22.6f\n\
//  $:\n\
//  $:  Max Fin-Init timer val = %22.6f at rank %7d\n\
//  $:  Min Fin-Init timer val = %22.6f at rank %7d\n\
//  $:  Avg Fin-Init timer val = %22.6f\n\
//  $:\n\
//  $:  Max Fin - Min Init val = %22.6f\n\
//  $:  Min Fin - Max Init val = %22.6f\n\
//  $:\n\
//  $:     Rank           Elapsed Time               MPI_Init\
...
//      te = tend_all[i];
//      telp = te - tb;
//      printf(" $: %8d %22.6f %22.6f %22.6f       %s\n",
//           i, telp, tb, te, &pname_all[maxlen*i]);
//    }
// //    printf(" $:\n\
// //  $:  TIMER Overhead (inside MPI) from Rank 0     = %18.6f\n",
// //  MPI_Wtime() - tend);
//    free (tbeg_all);
//    free (tend_all);
//    free (pname_all);
...
//  if (myid == 0){
//    ftimer2 = getCurrentTime();
// //    printf(" $:  TIMER and MPI_Finalize Overhead from Rank 0 = %18.6f\n\
// //  $:\n\
// //  $:\n\
// //  $:  *** End TIMER Timing Report ***\n", ftimer2 - ftimer1);
//   printf(" $:\n");
//   printf(" $:  *** End Timing Report ***\n");
//  }